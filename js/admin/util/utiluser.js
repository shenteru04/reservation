       window.addEventListener('load', function() {
        ...
        setTimeout(() => {
            ...
            document.getElementById('adminUsers').textContent = sampleUsers.filter(u => u.roleId === 1).length;
            document.getElementById('recentLogins').textContent = '12';
        }, 1500);
        ...
        function deleteUser(id) {
            ...
            if (user) {
                document.getElementById('confirmDelete').onclick = function() {
                    // Remove user from array (in real app, make API call)
        ...
        document.getElementById('userForm').addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                if (userData.user_id) {
                    ...
                    const index = sampleUsers.findIndex(u => u.id == userData.user_id);
                    if (index > -1) {
                        sampleUsers[index] = {
                            ...sampleUsers[index],
                            ...
                            role: userData.role_id === '2' ? 'Front Desk' : 'Handyman',
